...
public class SelectBfException extends Exception
{
	...
	public void setErrorMessage(int type)
	{
		...
		switch(type)
		{
			...
			case ROUND_NOT_STARTED:			str += "Round has not started, therefore this value isn't accessible."; break;
			case ROUND_NOT_ENDED:			str += "Round has not ended, therefore this value isn't accessible"; break;
		}
