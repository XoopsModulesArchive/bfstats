...
public class EventProcessor extends SelectBfClassBase
{
	...
	public EventProcessor(Namespace ns, RoundContext rc, PlayerManagementBase pmb,ScoreManagementBase smb,HospitalManagementBase hmb,PitStopManagementBase psmb,RoundInfoManagementBase rimb, HighwayManagementBase hwmb,KitManagementBase kmb)
	{
		super(ns);
		this.rc = rc;
		this.pmb = pmb;
